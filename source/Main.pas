...
uses
  ...
  LResources, LCLIntf,
  Registry, Contnrs, FileCtrl, Dialogs, Grids, mnLangClasses, Menus,
...
type
  ...
  TMainForm = class(TForm)
    ...
    Label9: TLabel;
    ToolsMnu: TMenuItem;
    RemoveDublicatedMnu: TMenuItem;
    ReportDuplicatedMnu: TMenuItem;
    RetranslateRepeatedMnu: TMenuItem;
    N3: TMenuItem;
    N10: TMenuItem;
    ReportRetranslateMnu: TMenuItem;
    ...
    procedure CleanAllMnuClick(Sender: TObject);
    ...
    procedure RemoveDublicatedMnuClick(Sender: TObject);
    procedure ReportDuplicatedMnuClick(Sender: TObject);
    procedure ProgressRreportMnuClick(Sender: TObject);
    procedure RetranslateRepeatedMnuClick(Sender: TObject);
    procedure ReportRetranslateMnuClick(Sender: TObject);
...
procedure TMainForm.CleanAllMnuClick(Sender: TObject);
begin
  //Project.Dictionary.Local.Clean(Project.Dictionary.Original);
end;
...
procedure TMainForm.RemoveDublicatedMnuClick(Sender: TObject);
var
  aLog: TStringList;
begin
  if Project.Dictionary.Original <> nil then
...
procedure TMainForm.RetranslateRepeatedMnuClick(Sender: TObject);
var
  aLog:TStringList;
begin
  if (Project <> nil) then
...
procedure TMainForm.ReportRetranslateMnuClick(Sender: TObject);
var
  aLog:TStringList;
begin
  if (Project <> nil) then
